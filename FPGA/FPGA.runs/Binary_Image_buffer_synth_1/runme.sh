...
HD_PWD='D:/git_working/Intelligent-Study-Bot/FPGA/FPGA.runs/Binary_Image_buffer_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Binary_Image_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Binary_Image_buffer.tcl
